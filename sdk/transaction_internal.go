...
type addOrUpdateDbrbProcessTransactionDTO struct {
	Tx struct {
		abstractTransactionDTO
	} `json:"transaction"`
	TDto transactionInfoDTO `json:"meta"`
...
func (dto *addOrUpdateDbrbProcessTransactionDTO) toStruct(*Hash) (Transaction, error) {
	info, err := dto.TDto.toStruct()
	if err != nil {
		return nil, err
	}
	...
	return &AddOrUpdateDbrbProcessTransaction{
		*atx,
	}, nil
}
